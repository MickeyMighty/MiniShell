...
| `signal` | <signal.h> |  typedef void (*sighandler_t)(int); sighandler_t signal(int signum, sighandler_t handler); | ![diagram1](https://indradhanush.github.io/images/shell-part-3/signals.jpg) [check the [man](https://man7.org/linux/man-pages/man2/signal.2.html) and check the source of the [diagram](https://indradhanush.github.io/blog/writing-a-unix-shell-part-3/)]|
