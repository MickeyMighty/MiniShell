...
| `waitpid` | <sys/types.h> <sys/wait.h> | pid_t waitpid(pid_t pid, int *wstatus, int options); | Suspends execution of the calling process until a child specified by pid argument has changed state.[check the [man](https://man7.org/linux/man-pages/man2/wait.2.html)]|
