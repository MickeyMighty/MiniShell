...
/*   Updated: 2021/03/10 23:52:22 by loamar           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	char	*check_dollar_cmd(char *content)
{
	int		pos;
...
char            *handler_dollar_env(t_msh *msh, t_list *cmd)
{
	if (cmd->content)
		cmd->content = check_dollar_cmd(cmd->content);
}
